...
const JobCompleted = ({navigation}) => {
    return (
        <View style={styles.container}>
<Image style={styles.img} source={require('../assets/icons/payment.png')} />  
<View>
    <Text style={{fontSize:20,fontWeight:"700",color:'black'}}>Job Completed</Text>

</View>

<View style={styles.btn}>
    
    <Button title="Go to Home" onPress={()=> navigation.navigate("BookingScreen")}/>
    </View>
